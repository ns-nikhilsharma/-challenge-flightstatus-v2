...
AI-assisted development was used across analysis, modelling, implementation, test design, and documentation. Significant prompts and judgement calls are documented in `prompts.md`.
